...
<?php if ( $workshop == 'deleted' ): ?>
    <div class="card">
        <hr>
        <div class="card-body">
            <p class="text-danger m-0"><?php $lang('feed_workshop_is_deleted') ?></p>
        </div>
    </div>
<?php return; ?>
<?php endif; ?>
<div class="card">
    ...
    <div class="card-body">
                ...
                <?php
                    ...
                    <?php else: ?>
                        ...
                        <?php if (!$order) : ?>
                            ...
                            <a href="<?= URL::full('login/'.$workshop['id'].'/'.Workshop::ENTITY_TYPE) ?>" class="d-md-block btn btn-primary pull-right"><?= $lang('workshop_feed_price', ['price' => number_format($priceWithPlatformFees, 2)]); ?></a>
        ...
        <?php else : ?>
            <div class="pull-right">
                ...
                <?php if ($workshop['status'] !== Workshop::STATUS_COMPLETED && $workshop['status'] !== Workshop::STATUS_CANCELED && !$started && $isExpired) : ?>
                    <a href="#" class="badge badge-danger pull-right"><?= $lang('expired') ?></a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        ...
        <h6 class="card-subtitle mb-2 text-muted">
            ...
            <span class="badge <?= $workshop['status'] == 'current' ? 'bg-success' : 'bg-secondary' ?>"><?= $lang($workshop['status']); ?></span>
        </h6>
