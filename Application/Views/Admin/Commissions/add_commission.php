                    ...
                    <form action="<?= URL::current() ?>" method="post">
                        <div class="card-body">
                            <div class="form-group required">
                                <label for="entity_commission"><?= $lang('select_an_entity') ?></label>
                                <select required class="form-control" id="entity_id" name="entity_id">
                            ...
                            <div class="form-group required">
                                <label for="entity_commission"><?= $lang('select_an_advisor') ?></label>
                                <select required class="form-control" id="advisor_id" name="advisor_id">
                                </select>
                            </div>
                            <div class="form-group required">
...
<define footer_js>
    <script>
        ...
        $('#entity_id').on('change', function(e) {
            ...
            var url = "<?= URL::full('/ajax/user/advisors-by-entities') ?>"
            callApi(url, {
                entityId: value
            }, function(data) {
                $('#advisor_id').empty();
                $('#advisor_id').append(data.payload)
            })
        })
