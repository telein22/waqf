                            ...
                            <div class="form-group">
                                ...
                                <select name="special_id" id="special_id" class="form-control">
                                    <?php foreach( $allSpecialties as $special ) : ?>
                                        <option <?php if($specialInfo['special_id'] == $special['id'] ) echo 'selected' ?> value="<?= $special['id'] ?>"><?= htmlentities($special['specialty_en']) . '/' . htmlentities($special['specialty_ar']) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <!-- /.card-body -->
