...
private string $instance;
    ...
    public static function generateQrCode(int $userId): void
    {
        $qrCodeContent = AppHelper::getBaseUrl() . "/outer-profile/{$userId}";
        ...
        $qrCodeImagePath = "Storage/BusinessCards/qr_code_{$userId}.png";
